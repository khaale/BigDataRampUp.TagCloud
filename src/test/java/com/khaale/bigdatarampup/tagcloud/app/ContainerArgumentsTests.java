...
public class ContainerArgumentsTests {
    ...
    @Test
    public void get_shouldReturnEmptyParams_whenLinesCountIs0() {
        //arrange
        int linesCount = 0;
    ...
    @Test
    public void get_shouldReturnEmptyParams_whenLinesCountIs1() {
        //arrange
        int linesCount = 0;
        int containersCount = 3;
    ...
    @Test
    public void get_shouldReturn1Param_whenContainersCountIs1() {
        //arrange
        int linesCount = 10;
    ...
    @Test
    public void get_shouldReturn2Params_whenContainersCountIs2() {
        //arrange
        int linesCount = 6;
